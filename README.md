...
## Getting Started
- First, you need to clone the repo: `https://github.com/aishurv/ExamProctor.git`
- Run the `requirement.txt` file for the installation.
- Run the `app.py` file.



_**Note:**_ You can read the project details [here](https://github.com/aishurv/ExamProctor/blob/main/OEP%20Project.pdf).
